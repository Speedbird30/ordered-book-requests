...
int MileageDiff(const void *a, const void *b)
{
    struct car *q1 = (struct car *)a;
    struct car *q2 = (struct car *)b;
    if (q1->City_MPG < q2->City_MPG)
    {
        return -1;
    }
    else if (q1->City_MPG == q2->City_MPG)
    {
        return 0;
    }
    else
...
{
    qsort(list, n, sizeof(struct car), MileageDiff);
}
